    ...
    <div className="mt-12 max-w-3xl pb-20">
      <div>
        <div className="font-normal leading-8">
          <span className="font-semibold">Question 1:</span> Define the problem
          statment in your own words.
        </div>
        <Textarea
      ...
      <div className="mt-14">
        <h2 className="font-normal leading-8">
          <span className="font-semibold">Question 2:</span> What data cleaning
          techniques do you want to use ?
        </h2>
        <Textarea
          placeholder="Your answer here (max 100 words)"
          className="w-full col-span-2 mt-4"
      ...
      <div className="mt-14">
        <h2 className="font-normal leading-8">
          <span className="font-semibold">Question 3:</span> Which data models
          do you want to use for the problem statement? Why?
        </h2>
        <Textarea
          placeholder="Your answer here (max 100 words)"
          className="w-full col-span-2 mt-4"
...
export default KernelkombatPhase1;
